...
1. **Rates have dropped at least 0.5%–1%** from your current rate. The larger the rate difference, the faster you break even.
2. **You plan to stay in the home long-term.** The longer your time horizon, the more total interest savings you accumulate.
3. **Your credit score has improved.** A higher score since you first got your mortgage could qualify you for a significantly better rate.
4. **You want to switch loan types.** Moving from an ARM to a fixed-rate loan adds stability even if the break-even is longer than you'd like.
