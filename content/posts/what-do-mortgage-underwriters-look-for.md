---
title: "What Mortgage Underwriters Look For Before Approving You"
date: 2026-07-10T17:31:26.491676+00:00
draft: false
description: "Discover the key factors mortgage underwriters evaluate, from income and credit to assets and property value, so you can get approved with confidence."
image: "/img/heroes/8292888.jpg"
categories: ["Underwriting"]
tags: ["what", "mortgage", "underwriters", "look"]
author: "Maria Santos"
...
slug: "what-do-mortgage-underwriters-look-for"
affiliate_disclosure: true
faqs:
  - q: "How long does underwriting usually take?"
    a: "For a straightforward file (W-2 income, strong credit, clean bank statements), underwriting typically takes 3 to 5 business days. Add complexity, like self-employment or a short sale in your credit history, and it can stretch to 2 to 3 weeks. Conditions add time on top of that."
  - q: "Can I get approved with student loan debt?"
    a: "Yes, and this is one area where the rules have evolved. Conventional loans and FHA loans treat student loans differently, particularly income-driven repayment plans. As of 2026, most conventional lenders count 1% of your student loan balance as a monthly obligation if the actual payment is deferred, though some will use the documented payment if you're on an active repayment plan. This is worth asking your loan officer about specifically."
  - q: "Will changing jobs hurt my application?"
    a: "It depends on whether you're staying in the same field. Moving from one employer to another in the same industry, especially for more money, is generally fine. Switching industries or going from salaried to self-employed during the application process can genuinely complicate things and may require you to wait 1 to 2 years before qualifying."
  - q: "What credit score do I actually need?"
    a: "A 620 is the floor for most conventional loans. FHA goes down to 580 with a 3.5% down payment, and some FHA lenders will go to 500 with 10% down (though finding one willing to do it is harder than it sounds). The higher your score, the better your rate. The difference between a 680 and a 740 score isn't just approval odds; it can affect the rate you're offered on a $350,000 loan by a meaningful margin over 30 years."
  - q: "What does 'compensating factors' mean when they're applied?"
    a: "Compensating factors are financial strengths that offset a weakness in your file. If your DTI is at 48% (normally too high for conventional), but you have 18 months of reserves in the bank, a 760 credit score, and a 20% down payment, the underwriter may still approve because the rest of your profile is solid. There's no formal list; it varies by loan type and whether the file went through automated underwriting or manual review."
---
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Months of income documentation typically required by employment type</div><div class="sc-row"><span class="sc-label">W-2 Employee</span><span class="sc-track"><span class="sc-bar" style="width:6%"></span></span><span class="sc-val">2 months</span></div><div class="sc-row"><span class="sc-label">Salaried + Bonus</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">24 months</span></div><div class="sc-row"><span class="sc-label">Self-Employed</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">24 months</span></div><div class="sc-row"><span class="sc-label">Commission-Only</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">24 months</span></div><div class="sc-row"><span class="sc-label">Seasonal Worker</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">24 months</span></div><div class="sc-row"><span class="sc-label">Newly Self-Employed</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">36 months</span></div><div class="sc-src">Source: Industry underwriting guidelines, July 2026</div></div>
...
A denial is what happens when the file doesn't meet the guidelines. If this happens to you, you have the right to a specific reason, and you should ask for it in writing. [HUD-approved housing counselors](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) can actually help you understand denial reasons and figure out a path forward, often at no cost. I send people there all the time and I think it's one of the most underused resources in the process.

## Sources

- [Freddie Mac MyHome](https://myhome.freddiemac.com/): Official homebuyer education and loan documentation guidance
- [HUD Housing Counseling Program](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor): Free and low-cost counseling for homebuyers and those facing denial
