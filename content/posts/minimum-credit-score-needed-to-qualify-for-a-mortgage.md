...
faqs:
  - q: "Can I get a mortgage with a 580 credit score?"
    a: "Yes, specifically through FHA loan programs, which technically allow scores as low as 500 (with 10% down) and 580 (with 3.5% down). The practical catch is that many individual lenders set their own minimums above FHA's floor, so you may need to shop multiple lenders to find one that will work with a 580."
  - q: "Does checking my own credit score hurt my mortgage application?"
    a: "No. When you check your own credit score, that's a soft inquiry and it has no impact on your score. Only hard inquiries, those initiated by lenders or creditors reviewing your application for new credit, affect your score. You can check your score as often as you want without any consequence."
  - q: "What credit score do I need for a conventional loan?"
    a: "The minimum is 620 for most conventional loans backed by Fannie Mae or Freddie Mac. But qualifying at 620 and getting a competitive rate at 620 are two different things. The pricing on conventional loans improves noticeably as scores climb toward 740 and above, so your approval odds and your actual cost are not the same calculation."
  - q: "Will my spouse's low credit score affect our joint mortgage application?"
...
**VA loans** for eligible veterans and active-duty service members technically have no minimum score set by the VA itself. Individual lenders impose their own requirements, but 580-620 is common in practice. VA loans are genuinely among the best mortgage products available, partly because they're more flexible on credit than the conventional market.

**USDA loans** for eligible rural properties are similar to VA in that the USDA doesn't publish a hard minimum, but most lenders require a 640 in practice, because that's the threshold above which the USDA's automated underwriting system (called GUS) will typically issue an approval without requiring manual review.

## Why Your Score Is Only Part of the Picture
...
## The Score You Qualify With vs. the Score That Gets You a Good Rate
...
If you have time and your score needs work, the mechanics here aren't mysterious.

The fastest lever is credit utilization, which is the ratio of your current balances to your credit limits. Utilization accounts for about 30% of your FICO score, and it's recalculated every time your card issuers report to the bureaus (usually monthly). If your cards are carrying high balances relative to their limits, paying them down to below 30% of each card's limit, and ideally below 10%, can show up in your score within a billing cycle or two.

Payment history is the biggest factor in your score (around 35% of FICO). If you have missed payments in your past, you can't erase them, but their impact fades over time. A 30-day late from three years ago matters a lot less than one from six months ago. Consistent on-time payments from this point forward are the most reliable way to improve a score that's been damaged by past delinquencies.

A few things to avoid in the 3-6 months before you apply: don't open new credit accounts, don't close old ones (closing reduces your available credit and can hurt utilization), and don't co-sign for anyone else's loan. Each hard inquiry from a new application can shave a few points off, and you want to walk into your mortgage application with a stable, clean picture.
...
Yes, specifically through FHA loan programs, which technically allow scores as low as 500 (with 10% down) and 580 (with 3.5% down). The practical catch is that many individual lenders set their own minimums above FHA's floor, so you may need to shop multiple lenders to find one that will work with a 580.

### Does checking my own credit score hurt my mortgage application?

No. When you check your own credit score, that's a soft inquiry and it has no impact on your score. Only hard inquiries, those initiated by lenders or creditors reviewing your application for new credit, affect your score. You can check your score as often as you want without any consequence.

### What credit score do I need for a conventional loan?

The minimum is 620 for most conventional loans backed by Fannie Mae or Freddie Mac. But qualifying at 620 and getting a competitive rate at 620 are two different things. The pricing on conventional loans improves noticeably as scores climb toward 740 and above, so your approval odds and your actual cost are not the same calculation.

### Will my spouse's low credit score affect our joint mortgage application?

If you apply jointly, most lenders use the lower of the middle scores from each borrower's three credit reports. One spouse's lower score can pull the qualifying score down and affect your rate, or in some cases make approval harder. Sometimes it makes sense for only the higher-score borrower to be on the mortgage application, though that person then has to qualify on their income alone.

### How long does it take to improve a credit score before applying for a mortgage?

It genuinely depends on what's dragging your score down. If it's high utilization, you can see meaningful improvement in 30-60 days after paying balances down. If it's a history of late payments or collections, expect a longer runway, typically 6-12 months of consistent on-time payments before you see significant movement. A credit counselor or HUD-approved housing counselor can give you a specific plan based on your actual report.
