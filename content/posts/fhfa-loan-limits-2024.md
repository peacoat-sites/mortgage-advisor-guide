---
title: "$766,550 FHFA Loan Limits 2024: What Changed"
date: 2026-08-11T16:40:50.892753+00:00
draft: false
description: "2024 FHFA loan limits increased significantly. See the new conforming loan limits by property type and region."
image: "/img/heroes/8482511.jpg"
categories: ["Loan Types"]
tags: ["fhfa", "loan", "limits", "2024"]
author: "Robert Kim"
...
slug: "fhfa-loan-limits-2024"
affiliate_disclosure: true
faqs:
  - q: "What is the FHFA conforming loan limit for 2024?"
    a: "The baseline limit for a single-family home in most U.S. counties is $766,550. High-cost counties (designated by FHFA annually) can have limits up to $1,149,825."
  - q: "What happens if my loan is above the conforming limit?"
    a: "Your loan becomes a 'jumbo' loan, which Fannie Mae and Freddie Mac won't purchase. You'll need to qualify through private lenders, often with stricter requirements: higher credit scores, larger reserves, and typically a higher interest rate."
  - q: "Does the conforming limit change every year?"
    a: "Yes, FHFA adjusts it each November based on their House Price Index. It has increased in most recent years because home prices have risen. The new limits take effect January 1 of the following year."
  - q: "Are conforming loan limits the same everywhere in the country?"
    a: "No. Most counties use the standard baseline ($766,550 in 2024), but 147 counties were designated 'high-cost' and received higher limits. Alaska, Hawaii, Guam, and the U.S. Virgin Islands automatically receive the highest allowable limit."
  - q: "Does a higher loan limit mean I can borrow more with less money down?"
    a: "Not exactly. The limit sets the maximum loan size that qualifies as conforming, but your lender still requires you to meet their down payment, credit, and debt-to-income standards. A higher limit just keeps you in conforming territory at a higher price point; it doesn't change the other qualification rules."
---

$726,200. That's the number that quietly changed whether millions of Americans could buy a home with a [conventional loan](/conventional-loan-requirements/) or got shunted into a more expensive product they didn't want. Most buyers never hear that figure until they're already in contract and their loan officer drops it like a surprise party nobody asked for.

I spent years on the underwriting side watching borrowers get blindsided by this. A couple in suburban Nashville would come in thrilled about a $760,000 home, their credit was solid, their [down payment](/how-to-buy-your-first-home-with-no-down-payment-in-2026/) ready, and then we'd have to explain that their loan would be classified differently because it crossed a threshold they'd never heard of. Half the time they thought we were making it up.

So let me explain what FHFA loan limits actually are, why they matter more than most first-[time buyers](/fha-vs-conventional-loan-which-is-better-for-first-time-buyers/) realize, and what the 2026 numbers mean for your specific situation. (A note on timing: the limits I'll focus on were set for 2024 but the framework and the general numbers I'm walking through are still the relevant baseline as of August 2026. Annual adjustments happen each November, so always confirm the current-year figure at FHFA.gov before you sign anything.)


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">The 2024 baseline conforming loan limit was $766,550 for single-family homes in most U.S. counties.</li><li style="margin:5px 0">High-cost areas (like San Francisco and Manhattan) received limits up to $1,149,825 in 2024.</li><li style="margin:5px 0">Loans above these limits are "jumbo" loans and typically require larger down payments and stricter qualification.</li><li style="margin:5px 0">Multi-unit properties get higher limits: $981,500 (2-unit), $1,186,350 (3-unit), $1,474,400 (4-unit) for standard areas.</li><li style="margin:5px 0">Alaska, Hawaii, Guam, and the U.S. Virgin Islands get 150% of the standard baseline automatically.</li></ul></div>
...
The FHFA adjusts conforming loan limits each year based on the Federal Housing Finance Agency House Price Index. In 2024, the baseline limit for a single-unit property rose to $766,550, up from $726,200 in 2023. That's a 5.56% increase, which tracked the annual home price appreciation data Fannie Mae published in their November 2023 release.

Here's the full picture for standard-cost areas in 2024:

| Property Type | 2024 Standard Limit | 2024 High-Cost Limit |
|---|---|---|
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">2024 Conforming Loan Limits by Property Type (Standard Areas)</div><div class="sc-row"><span class="sc-label">1-Unit</span><span class="sc-track"><span class="sc-bar" style="width:52%"></span></span><span class="sc-val">$766,550</span></div><div class="sc-row"><span class="sc-label">2-Unit</span><span class="sc-track"><span class="sc-bar" style="width:67%"></span></span><span class="sc-val">$981,500</span></div><div class="sc-row"><span class="sc-label">3-Unit</span><span class="sc-track"><span class="sc-bar" style="width:80%"></span></span><span class="sc-val">$1,186,350</span></div><div class="sc-row"><span class="sc-label">4-Unit</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$1,474,400</span></div><div class="sc-src">Source: FHFA 2024 Conforming Loan Limits</div></div>
...
The [Consumer Financial Protection Bureau (CFPB)](https://www.consumerfinance.gov/owning-a-home/) has solid resources on understanding the distinction between conforming and non-conforming loans if you want to go deeper on this. And if you're buying in a county you're not sure about, [HUD-approved housing counselors](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) can walk you through this for free, which is genuinely underused by buyers who could benefit from it.
...
For anyone who wants to go further on the math side, there are some genuinely good home-buying guides that explain this in context of your full mortgage decision. *The Mortgage Wars* by Timothy Howard or something more practical like a home-buying workbook ([options on Amazon](https://www.amazon.com/s?k=home+buying+guide+mortgage&tag=contentportfo-20)) can help you see loan limits as one piece of the larger picture, not an isolated rule. (Disclosure: links may earn a commission.)

## Sources

- [FHFA Conforming Loan Limits (2024)](https://www.fhfa.gov/DataTools/Downloads/Pages/Conforming-Loan-Limits.aspx): Official county-level limit lookup and annual limit history
- [Fannie Mae November 2023 Loan Limit Announcement](https://singlefamily.fanniemae.com/media/32961/display): Original 2024 limit announcement with methodology
- [Consumer Financial Protection Bureau (CFPB), Owning a Home](https://www.consumerfinance.gov/owning-a-home/): Plain-language explainer on conforming vs. jumbo loan distinctions
- [FHFA House Price Index (HPI)](https://www.fhfa.gov/DataTools/Downloads/Pages/House-Price-Index.aspx): The underlying data that drives annual limit adjustments
- [HUD Housing Counselor Locator](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor): Free counseling to help buyers understand loan options by county
