...
faqs:
 ...
 - q: "Is the extra payment worth it if I have a low interest rate, like 3%?"
...
The payment is applied to principal, not held. Ask if there's a "suspense account" in the process. If there is, and they're not applying it until the full amount is in, the benefit is delayed.
...
Call your servicer first. I put this step first because it's the one everyone skips. Before you change anything, find out: Does your servicer accept midcycle payments? Do they apply them immediately to principal? Is there a preferred method (online portal, check with a note, phone payment)?
...
Verify it's working. Pull your mortgage statement after the first two or three months and check the principal balance. It should be decreasing slightly faster than the standard amortization schedule on your closing disclosure. If it's not, call your servicer before the problem compounds.

## What Nobody Tells You About the Calendar
