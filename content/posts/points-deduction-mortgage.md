---
title: "Points Deduction on Mortgages: Save $2,000+ or Pay More?"
date: 2026-07-30T17:11:24.257153+00:00
draft: false
description: "Learn how mortgage points work, when $2,000-$8,000 in upfront costs make sense, and if paying points actually saves you money long-term."
image: "/img/heroes/20251480.jpg"
categories: ["Taxes"]
tags: ["points", "deduction", "mortgage"]
author: "Ethan Chen"
...
slug: "points-deduction-mortgage"
affiliate_disclosure: true
faqs:
  - q: "Can I deduct mortgage points if I didn't pay them out of pocket?"
    a: "It depends on how they were paid. If the points were paid from your own funds at closing, yes. If the seller paid them, you can still claim the deduction (while reducing your home's cost basis). If they were rolled into the loan, you typically cannot deduct them as points, because you didn't actually pay them in the year of closing."
  - q: "What if I forgot to claim mortgage points in a previous year?"
    a: "You can file an amended return (Form 1040-X) going back up to three years. If you bought a home and paid points in 2023 and forgot to deduct them, you can still file an amendment. This is actually pretty common, and the IRS processes it routinely."
  - q: "Do points paid on a second home or investment property qualify?"
    a: "Points on a second home are deductible, but you generally have to amortize them over the life of the loan (same as a refi). Points on a rental property are handled differently and deducted as a business expense over time, not as mortgage interest. If you have a rental, talk to a CPA because the rules interact with passive activity loss limits."
  - q: "How do I know if my origination fee counts as deductible points?"
    a: "Look at your Closing Disclosure, Section A. If the fee is expressed as a percentage of the loan (e.g., '1% of loan amount') and is for the use of money rather than for a specific lender service, it likely qualifies. Fees labeled as 'underwriting,' 'document prep,' or 'processing' generally don't. The IRS specifically says the fee must be computed as a percentage of the stated principal amount of the mortgage."
  - q: "Does the points deduction phase out at higher incomes?"
    a: "The deduction itself doesn't have an income-based phase-out the way some deductions do. However, the overall benefit depends on whether you itemize, and high earners in states with significant state income tax and property taxes are more likely to clear the itemization threshold. That said, the $10,000 SALT cap (still in effect as of 2026) limits how much state and local taxes can boost your itemized total, which affects some high earners in places like California and New York."
---

Most homeowners who paid points on their mortgage have no idea they left money on the table at tax time.

I'm not talking about a rounding error. The IRS allows you to deduct [mortgage points](/mortgage-points-explained/) as prepaid interest, and depending on how many points you paid and your loan size, that deduction can be worth hundreds or even thousands of dollars in actual tax savings. Yet the Consumer Financial Protection Bureau's homebuying research consistently finds that buyers focus almost entirely on their interest rate and monthly payment, often glossing over the closing cost breakdown where points are buried, usually under a label like "loan origination fee" or "discount points." By the time tax season rolls around, they've forgotten they paid them at all.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Mortgage points are deductible as prepaid interest under IRS rules if you meet specific conditions.</li><li style="margin:5px 0">One point equals 1% of the loan amount; on a $400,000 loan, one point = $4,000.</li><li style="margin:5px 0">On a purchase loan, points are often fully deductible in the year paid. Refinance points must usually be spread over the loan's life.</li><li style="margin:5px 0">You must itemize deductions (Schedule A) to claim this; it won't help if you take the standard deduction.</li><li style="margin:5px 0">Seller-paid points are also deductible for the buyer, which almost nobody knows.</li></ul></div>
...
Here's where most explainers lose people. The deductibility of points depends heavily on whether the loan is a purchase or a refinance. These are treated very differently.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Year-1 Points Deduction by Loan Scenario ($4,000 points paid)</div><div class="sc-row"><span class="sc-label">Purchase Loan</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$4,000</span></div><div class="sc-row"><span class="sc-label">30-Year Refi</span><span class="sc-track"><span class="sc-bar" style="width:4%"></span></span><span class="sc-val">$133</span></div><div class="sc-row"><span class="sc-label">15-Year Refi</span><span class="sc-track"><span class="sc-bar" style="width:7%"></span></span><span class="sc-val">$267</span></div><div class="sc-row"><span class="sc-label">Seller-Paid Purchase</span><span class="sc-track"><span class="sc-bar" style="width:88%"></span></span><span class="sc-val">$3,500</span></div><div class="sc-row"><span class="sc-label">Refi + Early Payoff</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$4,000</span></div><div class="sc-src">Source: IRS Publication 936 rules applied to illustrative scenarios, 2026</div></div>
...
- [IRS Publication 936 (current edition)](https://www.irs.gov/publications/p936): Official guidance on home mortgage interest, including points deductibility rules.
- [IRS Schedule A Instructions](https://www.irs.gov/instructions/i1040sca): Line-by-line instructions for itemizing deductions, including mortgage points.
- [Consumer Financial Protection Bureau (CFPB) Owning a Home resources](https://www.consumerfinance.gov/owning-a-home/): Explains closing costs, loan estimates, and mortgage terms in plain language.
- [Freddie Mac My Home](https://myhome.freddiemac.com/): Home buyer education resources including explanations of points and closing costs.
