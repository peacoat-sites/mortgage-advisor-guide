---
title: "How Much House Can You Afford on a $60K Salary?"
date: 2026-07-11T16:40:27.871332+00:00
draft: false
...
slug: "how-much-house-can-i-afford-on-60k-salary"
affiliate_disclosure: true
faqs:
  - q: "Can I afford a $250,000 house on a $60,000 salary?"
    a: "Possibly, but it depends heavily on your existing debt, down payment size, local property taxes, and current interest rates. At today's rates, a $250,000 home with 3.5% down could put your housing payment above 37% of gross income even before other debts, which gets tight fast. It's not impossible, but it leaves very little room for anything to go sideways."
  - q: "What credit score do I need to buy a house on a $60k income?"
    a: "For a conventional loan, you'll want at least a 620, though 680 and above gets you meaningfully better terms. FHA loans allow scores as low as 580 with 3.5% down. The higher your score, the lower your rate, and on a moderate income, that difference in monthly payment matters a lot more than it does for higher earners."
  - q: "How much should I save before buying a house on this salary?"
    a: "At minimum, you need closing costs (typically 2% to 5% of the purchase price) plus your down payment. On a $200,000 home, that's roughly $14,000 to $16,000 out of pocket at the low end. Having three to six months of housing costs in reserves after closing is also something lenders and, frankly, common sense both recommend."
  - q: "Does my take-home pay or gross salary matter for mortgage qualification?"
    a: "Lenders qualify you on gross income, not take-home. So your $60k salary means $5,000/month in their math. But your actual budget has to work on what hits your bank account, which after federal and state taxes is more like $3,700 to $4,000 depending on where you live. Always run your personal budget on take-home pay, not gross."
  - q: "Are there first-time buyer programs that help on a $60k income?"
    a: "Yes, and they're worth researching seriously. Many states offer down payment assistance grants or low-interest second mortgages specifically for buyers at this income level. Fannie Mae's HomeReady and Freddie Mac's Home Possible programs both allow lower down payments with reduced PMI costs for qualifying income levels. A HUD-approved housing counselor can tell you what's available in your state."
---
...
| DTI Target | Max Total Monthly Debt | If You Have $400/mo in Other Debt | Housing Budget Left |
|---|---|---|---|
...
Here's where a lot of first-time buyers get tripped up. They find an online calculator, plug in their income, and get a purchase price. What they don't realize is that the calculator assumed a 20% down payment they don't have.
...
As of July 2026, mortgage rates on a 30-year fixed loan are sitting in a range that makes the monthly math noticeably tighter than it was a few years back. I'm not going to quote a specific rate because they move, but you can check current rates at any major lender or use a good mortgage calculator to run your own numbers. (The [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) publishes weekly rate data if you want an unbiased source.)
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Estimated Monthly PITI by Home Price (3.5% down, current rates)</div><div class="sc-row"><span class="sc-label">$150,000</span><span class="sc-track"><span class="sc-bar" style="width:61%"></span></span><span class="sc-val">$1,150</span></div><div class="sc-row"><span class="sc-label">$175,000</span><span class="sc-track"><span class="sc-bar" style="width:70%"></span></span><span class="sc-val">$1,320</span></div><div class="sc-row"><span class="sc-label">$200,000</span><span class="sc-track"><span class="sc-bar" style="width:80%"></span></span><span class="sc-val">$1,510</span></div><div class="sc-row"><span class="sc-label">$225,000</span><span class="sc-track"><span class="sc-bar" style="width:90%"></span></span><span class="sc-val">$1,690</span></div><div class="sc-row"><span class="sc-label">$250,000</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$1,880</span></div><div class="sc-src">Source: Industry estimates, July 2026</div></div>
...
**Scenario 1:** $60k salary, 740 credit score, $12,000 saved (roughly 5.5% on a $220k home), one car payment of $280/month, no student loans.
Action taken: Conventional loan, 5% down, 30-year fixed.
Result: Qualifies comfortably for a purchase price around $220,000 to $235,000. Monthly housing cost lands near $1,650 to $1,750, which is about 33-35% of gross income.

**Scenario 2:** Same salary, 680 credit score, $8,500 saved, $620/month in student loans and a credit card minimum.
Action taken: FHA loan, 3.5% down.
Result: Back-end DTI hits 47% at $195,000. Technically qualifies, but take-home after taxes is around $3,900, and $1,850 in monthly debt payments leaves a tight buffer. A $175,000 to $185,000 purchase is more sustainable.

**Scenario 3:** $60k salary, 760 credit score, $45,000 saved, zero other debt.
Action taken: 20% down on a $220,000 home, conventional loan, no PMI.
Result: Monthly payment around $1,380 to $1,450. Clean approval, excellent rate, no PMI burning $150/month forever.

The difference between Scenario 1 and Scenario 3 isn't income. It's preparation.

## What I'd Actually Do

If you're earning $60k and haven't bought yet, I'd suggest spending 30 minutes with a [HUD-approved housing counselor](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) before you talk to a single lender. It's usually free. They'll pull your full debt picture, walk through realistic scenarios for your specific area, and tell you what programs you actually qualify for. First-time buyer programs in many states can provide down payment assistance or below-market rates that change the math considerably.
...
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Weekly mortgage rate data and conforming loan limit information
- [HUD Housing Counselor Locator](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor): Free and low-cost homebuying counseling resources by location
