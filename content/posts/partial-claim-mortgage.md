...
slug: "partial-claim-mortgage"
affiliate_disclosure: true
faqs:
  - q: "Who qualifies for a partial claim on an FHA mortgage?"
    a: "You must have an FHA-insured loan, be between one and twelve months delinquent, and be able to demonstrate that you can resume making your regular first-mortgage payment. The servicer evaluates your financial situation and submits the claim to HUD on your behalf."
  - q: "Do I have to repay the partial claim every month?"
    a: "No. There are no monthly payments on a partial claim. The balance is due in full when you sell the home, refinance, or pay off the first mortgage. No interest accrues on the outstanding amount."
  - q: "Will a partial claim hurt my credit?"
    a: "The partial claim itself doesn't generate new negative credit reporting, but the delinquency that preceded it already has. The lien is a matter of public record once recorded, but it's not a collection account or a foreclosure. Resuming on-time payments on your first mortgage is what starts rebuilding your credit profile."
  - q: "Can I refinance if I have a partial claim lien on my property?"
...
Here's where a lot of borrowers get tripped up: you don't apply for a partial claim directly with HUD. You go through your mortgage servicer. HUD authorizes the servicer to offer it, and the servicer evaluates your eligibility.
...
Some servicers offer a combination: a partial claim to cover arrears plus a modification to reduce the ongoing payment. That's called a COVID-19 Recovery Modification, and as of this year it's still referenced in servicer guidelines, though the specific COVID-era program names have evolved. The [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) tracks loss mitigation data that shows combination approaches often outperform either option alone on re-default rates, which tells you something.
...
[Freddie Mac's home buyer resources](https://myhome.freddiemac.com/) have solid explainers on how subordinate liens affect refinancing eligibility, which is worth reading before you commit to anything.
...
For borrowers who want to go deeper on the mechanics of mortgage debt and your rights during default, resources like *The Mortgage Wars* or HUD-certified homebuyer guides (available on [Amazon](https://www.amazon.com/s?k=mortgage+default+borrower+rights+guide), note the site may earn a commission) can fill in the gaps a servicer conversation won't.

---

## Sources

- [HUD Mortgagee Letter ML 2021-18](https://www.hud.gov/program_offices/housing/sfh/nsc/qaho0121): HUD guidance on FHA COVID-19 loss mitigation options, including partial claim parameters.
- [Federal Housing Finance Agency (FHFA) Loss Mitigation Reports](https://www.fhfa.gov/): Annual data on servicer loss mitigation activity and re-default rates.
- [HUD Single Family Housing Policy Handbook 4000.1](https://www.hud.gov/program_offices/housing/sfh/handbook_4000-1): The definitive source for FHA loan servicing requirements and partial claim eligibility rules.
- [Consumer Financial Protection Bureau Mortgage Servicing Rules](https://www.consumerfinance.gov/compliance/compliance-resources/mortgage-resources/mortgage-servicing/): Federal rules governing servicer obligations to offer loss mitigation options.
- [Freddie Mac MyHome Advisor](https://myhome.freddiemac.com/): Practical guidance on how subordinate liens affect refinancing and home sale proceeds.
