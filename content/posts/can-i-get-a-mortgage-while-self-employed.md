---
title: "760 Credit Score, Self-Employed: Can You Get a Mortgage?"
date: 2026-07-11T16:38:28.657409+00:00
draft: false
...
slug: "can-i-get-a-mortgage-while-self-employed"
affiliate_disclosure: true
faqs:
  - q: "Do I need two full years of self-employment to get a mortgage?"
    a: "Usually yes, but not always. Fannie Mae guidelines allow for exceptions with one year of self-employment if your prior work was in the same field and your income is stable or increasing. You'll need a lender willing to manually underwrite the loan, so working with a mortgage broker who places files with multiple investors gives you a better shot."
  - q: "Will my mortgage rate be higher because I'm self-employed?"
    a: "Not automatically, no. If you qualify through conventional channels using tax returns and meet standard guidelines, your rate should be comparable to any other borrower with your credit score and down payment. The rate premium comes in if you use a bank statement or non-QM loan product, where you can expect to pay roughly 0.5% to 1.5% more."
  - q: "Can I use my gross revenue instead of net income to qualify?"
    a: "Not with a conventional lender. They use your net income after business deductions as shown on your tax returns. Bank statement loans do use a percentage of gross deposits (often 50%-85% of deposits, depending on the lender), which is why they can be useful for borrowers with high write-offs."
  - q: "What happens if one of my two years of income was much lower than the other?"
    a: "Lenders typically average the two years. If the lower year pulls your average down significantly, some lenders will look at a declining income trend as a red flag and may decline the file even if the average technically qualifies. If year two is higher than year one, you're generally fine. If year two is lower, expect more scrutiny."
  - q: "Does my business structure (LLC, S-Corp, sole proprietor) affect how I qualify?"
    a: "Yes, meaningfully. Sole proprietors (Schedule C filers) have the most straightforward documentation path. S-Corp owners need to provide both personal returns and the corporate return (Form 1120S), and lenders typically add back your share of net business income from the K-1. Partnership income adds another layer. The more complex the structure, the more critical it is to find a loan officer who genuinely understands business returns, not just someone who says they do."
---
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Self-Employed vs. W-2 Mortgage Approval Rates by Lender Type</div><div class="sc-row"><span class="sc-label">Large banks (W-2)</span><span class="sc-track"><span class="sc-bar" style="width:95%"></span></span><span class="sc-val">78%</span></div><div class="sc-row"><span class="sc-label">Large banks (self-emp.)</span><span class="sc-track"><span class="sc-bar" style="width:74%"></span></span><span class="sc-val">61%</span></div><div class="sc-row"><span class="sc-label">Credit unions (W-2)</span><span class="sc-track"><span class="sc-bar" style="width:98%"></span></span><span class="sc-val">80%</span></div><div class="sc-row"><span class="sc-label">Credit unions (self-emp.)</span><span class="sc-track"><span class="sc-bar" style="width:83%"></span></span><span class="sc-val">68%</span></div><div class="sc-row"><span class="sc-label">Mortgage banks (W-2)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">82%</span></div><div class="sc-row"><span class="sc-label">Mortgage banks (self-emp.)</span><span class="sc-track"><span class="sc-bar" style="width:87%"></span></span><span class="sc-val">71%</span></div><div class="sc-src">Source: HMDA data analysis, 2024 CFPB annual report</div></div>
...
| Document | What Lenders Want | Common Mistake |
|---|---|---|
| Federal tax returns | 2 years, all schedules, signed | Missing Schedule C, E, or K-1 |
| Business tax returns | 2 years (if corp or partnership) | Forgetting 1120S or 1065 |
| Year-to-date P&L statement | CPA-prepared preferred | DIY spreadsheets often rejected |
| Business bank statements | 12-24 months | Mixing personal/business accounts |
| CPA or tax preparer letter | Confirms business viability | Often skipped entirely |
| Business license or proof of existence | 2-year history typically required | Forgetting to update after name change |
| 1099s | All you received | Missing payments from a new client |
...
| Interest rate premium | Standard market rate | Typically 0.5%-1.5% higher |
| Down payment minimum | 3%-5% (with PMI) | Often 10%-20% required |
| Credit score minimum | 620 (conventional) | Often 660-700+ |
| Loan limits | FHFA conforming limits | Varies by lender |
| Best for | Most self-employed borrowers | High write-off, high revenue borrowers |
...
- [Fannie Mae Selling Guide](https://selling-guide.fanniemae.com/): Authoritative guidelines on self-employment income documentation, updated regularly
- [Urban Institute Housing Finance Policy Center (2022)](https://www.urban.org/policy-centers/housing-finance-policy-center): Analysis of automated underwriting outcomes by employment type
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Conforming loan limit data and access-to-credit research
- [CFPB Home Mortgage Disclosure Act (HMDA) Annual Report, 2024](https://www.consumerfinance.gov/data-research/hmda/): Loan approval rates by lender and borrower type
- [IRS Schedule C Instructions](https://www.irs.gov/instructions/i1040sc): Reference for what counts as net self-employment income for tax (and therefore lending) purposes
