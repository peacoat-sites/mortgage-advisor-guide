...
slug: "fha-condo-approval"
affiliate_disclosure: true
faqs:
  - q: "Can I use an FHA loan to buy a condo without full project approval?"
    a: "Yes, if the unit qualifies under Single Unit Approval. SUA has its own checklist of project-level requirements (owner-occupancy rate, delinquency rate, concentration limits), but it's a legitimate path and many buyers use it successfully. Ask your loan officer to run SUA eligibility before assuming the deal is dead."
  - q: "How do I find out if a condo project is FHA-approved?"
    a: "Use HUD's Condo Project Search tool, available at HUD.gov. Search by project name or location. If the status shows 'approved,' you're in good shape. If it shows 'expired' or the project isn't listed at all, talk to your lender about whether SUA or full project approval is an option."
  - q: "Can the HOA apply for FHA approval after I'm already in contract?"
    a: "Technically yes, but this is almost never a good idea to count on while you're in contract. Full project approval can take months, and there's no guarantee of success. If you're in contract and discover the project isn't approved, it's faster to pursue SUA or switch loan products than to wait for a new approval."
  - q: "Does FHA condo approval affect my mortgage rate?"
...
For anyone working with a tricky situation, a [HUD-approved housing counselor](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) can help you think through whether to push forward or pivot. They're free or low-cost, and they don't have a commission riding on your decision.
...
- [HUD Mortgagee Letter 2019-01](https://www.hud.gov/sites/dfiles/OCHCO/documents/19-01ml.PDF): FHA's reintroduction of Single Unit Approval for condominiums, including eligibility criteria
- [HUD Condo Project Search](https://entp.hud.gov/idapp/html/condlook.cfm): Official HUD database of FHA-approved condominium projects
- [Consumer Financial Protection Bureau, Owning a Home](https://www.consumerfinance.gov/owning-a-home/): CFPB's homebuying resource covering loan types, closing costs, and what to expect in the approval process
...
*Photo: [Mahmoud Zakariya](https://www.pexels.com/@mahmoud-zakariya-2154822140) via Pexels*
