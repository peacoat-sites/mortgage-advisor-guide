...
|---|---|
| You need supplemental income and plan to stay in the home long-term | HECM line of credit or tenure payments |
| You need a large lump sum for medical costs | Consider HELOC or cash-out refinance first (lower cost if you can qualify) |
| You want to delay Social Security until 70 for higher benefits | HECM as a bridge strategy can work well |
| You plan to move within 5 years | Almost certainly not worth the upfront costs |
| You want to leave maximum equity to heirs | Reverse mortgage accelerates equity erosion; consider alternatives |
| You have a spouse under 62 | Understand non-borrowing spouse protections carefully before signing |
...
A reverse mortgage can be a legitimate retirement planning tool, or it can be the most expensive loan you ever signed. The difference usually comes down to whether you understood the compounding math, had a candid conversation with your heirs, and explored the alternatives before committing. The loan officer's job is to close the loan. Your job is to decide whether it's actually right for you, and for that, an independent counselor and a fee-only planner are worth every dollar.
