---
title: "Foreclosure vs Short Sale: Which Path Saves Your Credit"
...
slug: "foreclosure-vs-short-sale"
affiliate_disclosure: true
faqs:
  - q: "Does a short sale always hurt your credit less than a foreclosure?"
    a: "Generally yes, but 'less' is relative. Expect a short sale to drop your score 100-150 points and a foreclosure 150-200+ points. Both are serious negatives. The more meaningful advantage is the shorter waiting period (4 years vs. 7 years) before qualifying for a new conventional mortgage."
  - q: "Can a lender still sue me after a short sale?"
    a: "Yes, unless you negotiate a written deficiency waiver as part of the approval. Some states prohibit deficiency judgments on primary residences; others allow them freely. Get the waiver in the closing documents regardless. Never assume goodwill."
  - q: "How long does a short sale stay on your credit report?"
    a: "Seven years from the date of first delinquency, same as a foreclosure. The practical difference is how future lenders read the notation and the mortgage waiting period, not the length of time it appears."
  - q: "What if my lender won't approve the short sale?"
    a: "You can appeal, resubmit with additional documentation, or request escalation to a senior loss mitigation specialist. If the first offer was rejected because of the BPO, sometimes bringing comparable sales data to dispute their valuation helps. A real estate attorney or HUD-approved housing counselor can assist with this."
  - q: "Is a deed-in-lieu of foreclosure better than both options?"
    a: "Sometimes. A deed-in-lieu means you voluntarily sign the property back to the lender in exchange for release from the mortgage. Credit impact and waiting periods are similar to short sale. The advantage: faster and simpler process. The catch: lenders often won't accept it if there are other liens on the property, and you still need the deficiency waiver in writing."
---

Most coverage of foreclosure vs. short sale buries the lead: the difference between these two outcomes isn't just about your [credit score](/credit-score-for-mortgage-approval/). It's about who controls the process, how long it takes, and whether you walk away with anything left to rebuild on.

Both happen when a homeowner can't keep up with [mortgage payments](/how-to-set-up-biweekly-mortgage-payments-to-pay-off-faster/). That's where the similarity ends.

A foreclosure is the lender taking the wheel. You stop paying, the clock starts ticking, and eventually the bank repossesses the home through a legal process and sells it to recover what you owe. A [short sale](/short-sale-mortgage-impact/) is you taking the wheel, with the bank's permission. You sell the home for less than the outstanding mortgage balance, the lender agrees to accept that lower amount, and you avoid the courtroom drama. In theory. In practice, short sales are their own special kind of bureaucratic purgatory, which I'll get to.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">A short sale typically damages your credit less than foreclosure: roughly 100-150 points vs. 150-200+ points.</li><li style="margin:5px 0">Foreclosure timelines vary by state: as little as 90 days (non-judicial) to 2+ years (judicial states like New York).</li><li style="margin:5px 0">Short sales require lender approval and average 3-6 months to close, sometimes longer.</li><li style="margin:5px 0">After foreclosure, Fannie Mae guidelines currently require a 7-year wait before a new conventional mortgage; short sale is typically 4 years.</li><li style="margin:5px 0">Forgiven debt in either scenario may be taxable income, consult a tax professional before signing anything.</li></ul></div>
...
The CFPB has straightforward [resources on this](https://www.consumerfinance.gov/owning-a-home/) if you want to read the federal guidelines directly rather than trust a third-party summary.
...
- [Consumer Financial Protection Bureau (CFPB) -- Owning a Home](https://www.consumerfinance.gov/owning-a-home/): Federal guidance on mortgage options, foreclosure alternatives, and borrower rights.
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Oversees Fannie Mae and Freddie Mac; publishes servicer guidelines relevant to short sale and foreclosure timelines.
- [Fannie Mae Selling Guide](https://selling-guide.fanniemae.com/): Official source for conventional loan waiting periods after foreclosure, short sale, and deed-in-lieu.
- [IRS Publication 4681](https://www.irs.gov/publications/p4681): Covers canceled debt, foreclosures, repossessions, and abandonment for tax purposes.
- [HUD-Approved Housing Counseling](https://www.hud.gov/program_offices/housing/sfh/hcc/hcs): Free counseling resources for homeowners facing financial hardship or foreclosure.
