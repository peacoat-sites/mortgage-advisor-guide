---
title: "How Much House Can You Afford on $80K Salary"
date: 2026-08-03T17:30:40.450639+00:00
draft: false
description: "Calculate your home buying budget on an $80,000 salary. Learn lending limits, down payment requirements, and what price range works for your income."
...
faqs:
  - q: "How much house can I afford on $80k with no debt?"
    a: "With no other monthly debt obligations and a solid credit score, you could potentially qualify for a home in the $330,000–$400,000 range, depending on your down payment, local taxes, and current interest rates. Always model the full monthly payment including taxes and insurance, not just principal and interest."
  - q: "What credit score do I need to buy a house on $80,000 a year?"
    a: "You can technically qualify for an FHA loan with a score as low as 580 (with 3.5% down), but practically speaking, you'll get noticeably better rates and terms at 680 and above. At 740 and higher, you access the best conventional pricing. If you're at 620, the loan is possible but expensive."
  - q: "How much do I need for a down payment on an $80k salary?"
    a: "Down payment requirements depend on loan type: FHA allows as little as 3.5%, conventional loans start at 3% for first-time buyers. But you'll also need closing costs (typically 2%–4% of the purchase price) on top of your down payment, and ideally some reserves afterward. Budget for all three, not just the down payment number."
  - q: "Does it make more sense to buy with 5% down or save longer for 20%?"
    a: "This one genuinely depends on your market, your rent situation, and how quickly home prices are moving in your area. In a stable or slower market, taking an extra year to save more down payment can save you real money on PMI and your rate. In a market where prices are rising fast, waiting has its own cost. I don't have a universal answer here, and anyone who gives you one without knowing your situation is guessing."
  - q: "What monthly payment should I target on an $80,000 salary?"
    a: "A commonly used guideline is keeping total housing costs (mortgage, taxes, insurance, HOA) under 28% of gross monthly income. On $80k, that's roughly $1,867/month. In practice, many buyers push closer to 32%–35% and manage fine, but it leaves less buffer for emergencies, job changes, or home repairs. Be honest with yourself about how comfortable you are with a tight budget."
---

Here's something most salary calculators won't tell you: $80,000 a year sounds like a solid income until you're sitting across from a loan officer and she starts asking about your [student loans](/mortgage-with-student-loans/), your car payment, and whether you have kids. That's when the number on your pay stub starts feeling a lot smaller.
...
At $80,000 a year, most buyers can comfortably afford a home somewhere in the range of $240,000 to $350,000, depending on your debts, your [down payment](/down-payment-from-401k/), your credit score, and where you live. Some people stretch to $400,000. Some shouldn't go above $250,000. The range isn't because I'm being vague, it's because those individual factors genuinely swing the number by six figures.


<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">On $80k/year, a realistic target home price is roughly $240,000–$350,000 before debts.</li><li style="margin:5px 0">Your debt-to-income ratio (DTI) matters more than your salary alone.</li><li style="margin:5px 0">With no other debts and 20% down, some buyers at $80k can qualify up to ~$400,000.</li><li style="margin:5px 0">FHA loans allow higher DTI but add mortgage insurance, often $150–$200/month extra.</li><li style="margin:5px 0">Local property taxes and insurance can shift affordability by $50,000+ in home price.</li></ul></div>
...
The first is your front-end ratio: how much of your gross monthly income goes toward housing costs (principal, interest, taxes, insurance, and HOA if applicable). Most conventional loans want this under 28%. [That means](/why-the-fed-may-hike-rates-next-and-what-that-means-for-your-mortgage/) your total housing payment shouldn't exceed roughly $1,867/month.
...
<style>.stat-chart{margin:28px 0;padding:18px 20px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)}.stat-chart .sc-title{font-weight:700;margin-bottom:12px;color:var(--heading,#1e293b)}.stat-chart .sc-row{display:flex;align-items:center;gap:10px;margin:7px 0}.stat-chart .sc-label{flex:0 0 34%;font-size:.85rem;color:var(--muted,#475569);text-align:right;overflow-wrap:anywhere}.stat-chart .sc-track{flex:1;background:var(--border,#e7e5e4);border-radius:6px;height:14px;overflow:hidden}.stat-chart .sc-bar{display:block;height:100%;background:var(--accent,#4338ca);border-radius:6px}.stat-chart .sc-val{flex:0 0 auto;font-size:.82rem;font-weight:600;color:var(--heading,#1e293b);min-width:56px}.stat-chart .sc-src{margin-top:10px;font-size:.75rem;color:var(--muted,#64748b)}@media(max-width:560px){.stat-chart .sc-label{flex-basis:42%}}</style><div class="stat-chart"><div class="sc-title">Monthly payment on $300,000 home by down payment (6.8% rate, August 2026)</div><div class="sc-row"><span class="sc-label">3% down ($9k)</span><span class="sc-track"><span class="sc-bar" style="width:100%"></span></span><span class="sc-val">$1,923</span></div><div class="sc-row"><span class="sc-label">5% down ($15k)</span><span class="sc-track"><span class="sc-bar" style="width:98%"></span></span><span class="sc-val">$1,884</span></div><div class="sc-row"><span class="sc-label">10% down ($30k)</span><span class="sc-track"><span class="sc-bar" style="width:94%"></span></span><span class="sc-val">$1,808</span></div><div class="sc-row"><span class="sc-label">20% down ($60k)</span><span class="sc-track"><span class="sc-bar" style="width:88%"></span></span><span class="sc-val">$1,697</span></div><div class="sc-src">Source: Mortgage amortization estimates, August 2026</div></div>
...
| Scenario | Home Price | Down | Est. Rate | Principal + Interest | PMI | Est. Total Housing Pmt |
|---|---|---|---|---|---|---|
| FHA, 3.5% down | $260,000 | $9,100 | 7.1% | $1,680 | $175/mo | ~$2,100+ |
| Conventional, 5% down | $280,000 | $14,000 | 6.9% | $1,760 | $155/mo | ~$2,100+ |
| Conventional, 10% down | $300,000 | $30,000 | 6.8% | $1,760 | $100/mo | ~$2,050+ |
| Conventional, 20% down | $320,000 | $64,000 | 6.7% | $1,860 | $0 | ~$2,100+ |
...
- [Freddie Mac My Home](https://myhome.freddiemac.com/): Home buyer education resources and mortgage payment calculators
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Data on conventional loan pricing, credit score adjustments, and conforming loan limits
