...
image: "https://images.pexels.com/photos/7821707/pexels-photo-7821707.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
...
**Step 2: Get a Loan Estimate.** Under federal law, any lender must give you a Loan Estimate within three business days of receiving your application. This document shows your projected new rate, monthly payment, closing costs, and cash needed to close. Freddie Mac's home buyer education resources have useful tools for understanding what to look for in these documents.
...
## Comparison: FHA vs. VA IRRRL vs. USDA Streamlined Assist

| Feature | FHA Streamline | VA IRRRL | USDA Streamlined Assist |
|---|---|---|---|
| Who qualifies | Existing FHA borrowers | Existing VA loan borrowers | Existing USDA loan borrowers |
| Appraisal required | Generally no | No | No |
| Income verification | No (non-credit-qualifying) | No | No |
| Credit check | No (non-credit-qualifying) | No | No |
| Minimum payments made | 6 payments, 210 days | No specific minimum | 12 consecutive on-time payments |
| Net tangible benefit required | Yes (0.5% rate reduction) | Yes (lower payment or ARM to fixed) | Yes ($50+ monthly payment reduction) |
