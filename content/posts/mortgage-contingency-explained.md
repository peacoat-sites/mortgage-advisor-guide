...
slug: "mortgage-contingency-explained"
affiliate_disclosure: true
faqs:
  - q: "What's the difference between a mortgage contingency and a financing contingency?"
    a: "Practically speaking, they mean the same thing and are used interchangeably in most markets. Some contracts use 'financing contingency' as the broader term (covering any type of loan), while 'mortgage contingency' is slightly more specific, but the function is identical: you get your earnest money back if you can't secure financing on the agreed terms."
  - q: "Can a seller cancel the contract if I don't remove my mortgage contingency on time?"
    a: "Yes, in many states. If your contingency has a deadline and you haven't removed it or invoked it by that date, the seller may have the right to issue a 'notice to perform' and, if you don't respond quickly, cancel the contract and potentially keep your earnest money. The exact rules vary by state, so check with a local real estate attorney if you're approaching a deadline with an unresolved loan."
  - q: "Does a pre-approval letter mean my mortgage contingency is basically already met?"
    a: "No, and this is a really common misconception. A standard pre-approval is based on a surface-level review of your finances. It is not a loan commitment. The mortgage contingency isn't 'met' until you have a formal loan approval (usually a commitment letter or clear-to-close), and even then, it typically stays in place until the lender is ready to fund. A pre-underwriting, which is more rigorous, gets you closer, but the contingency still matters until closing."
  - q: "What happens to my earnest money if I invoke the mortgage contingency?"
...
Mortgage contingencies aren't open-ended. They have a deadline, typically somewhere between 21 and 45 days from the contract date, though this varies significantly by region and by how competitive the market is. As of July 2026, in high-demand metros, I'm hearing from buyers who are being pressured to accept contingency windows as short as 14 to 17 days. That is very tight.
...
If you're working with a [HUD-approved housing counselor](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) as part of a first-time buyer program, they can often help you think through contingency negotiation in the context of your specific loan type. It's a free resource that most buyers ignore.

One more thing that gets glossed over: some state-specific contract forms have very different default language around contingencies. What's standard in Massachusetts may be materially different from what's standard in Texas. The [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) doesn't regulate contingency language, so this really does come down to local contract norms and what your agent puts in front of you. Ask specifically what the default language says and what it means if you do nothing.
...
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Official regulatory body overseeing conforming loan standards; referenced for what FHFA does and does not govern in purchase contracts.
- [U.S. Department of Housing and Urban Development (HUD)](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor): Free housing counseling referral program for homebuyers, including guidance on purchase contracts and loan terms.
