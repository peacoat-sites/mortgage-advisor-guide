---
title: "How Much House a $100K Salary Can Actually Buy"
date: 2026-07-08T17:12:58.804711+00:00
draft: false
...
slug: "how-much-house-can-i-afford-on-100k-salary"
affiliate_disclosure: true
faqs:
  - q: "Can I afford a $400,000 home on a $100,000 salary?"
    a: "Possibly, but it depends heavily on your down payment, existing debt, and the property taxes where you're buying. With a 10% down payment and no other debt, you're looking at a monthly payment in the $2,800 to $3,200 range depending on location, which pushes your front-end DTI toward 34-38%. That's within conventional lending limits but leaves little financial breathing room."
  - q: "How much do I need saved before buying a home on this salary?"
    a: "At minimum, you'd want 3-5% for a down payment (if using an FHA or low-down conventional program), plus 2-5% of the loan amount for closing costs, plus 3-6 months of living expenses in reserves. Realistically, for a $300,000 purchase, that often means $30,000 to $50,000 saved before you're in a comfortable position."
  - q: "Does my credit score change how much house I can afford?"
    a: "Yes, meaningfully. A credit score of 760+ typically qualifies you for the best rates. A score of 640 might get you approved but at a rate that's 0.5 to 1 percentage point higher, which on a $300,000 loan can add $90 to $180 per month to your payment over the life of the loan."
  - q: "Should I put 20% down or use that money differently?"
    a: "Putting 20% down eliminates PMI and reduces your monthly payment and total interest paid. But if that 20% wipes out your savings and leaves you with no emergency fund, it's a risky move. Most financial advisors suggest keeping 3-6 months of expenses liquid even after closing. I've seen people stretch to hit 20% and then finance a furnace replacement on a credit card six months later."
  - q: "What loan programs are available for first-time buyers at this income level?"
    a: "At $100,000, you may qualify for FHA loans (3.5% down, more flexible DTI thresholds), Fannie Mae's HomeReady or Freddie Mac's Home Possible programs (3% down for qualifying buyers), and various state-level down payment assistance programs. Income limits apply to some of these programs, and at $100,000 you may be near or above limits in lower-cost states. Check your state housing finance agency's website for specifics."
---
...
If [HUD-approved housing counselors](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) are available in your area (and they often offer free consultations), use them before you start shopping. They'll help you build an actual budget around the full picture, not just the mortgage payment.
...
- [Consumer Financial Protection Bureau (CFPB) – Owning a Home](https://www.consumerfinance.gov/owning-a-home/): Official guidance on loan estimates, closing disclosures, and understanding mortgage costs.
- [HUD – Talk to a Housing Counselor](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor): HUD-approved counselors who provide free or low-cost homebuying guidance.
- [Fannie Mae – Selling Guide, Debt-to-Income Ratios](https://selling-guide.fanniemae.com/): The source document for conventional loan DTI guidelines used by most U.S. lenders.
- [National Association of Realtors – Home Affordability Data](https://www.nar.realtor/research-and-statistics): Ongoing housing market data including price trends and affordability indices.
- [Tax Foundation – Property Taxes by State](https://taxfoundation.org/data/all/state/property-taxes-by-state-county/): Comparative property tax rates across U.S. states and counties.
