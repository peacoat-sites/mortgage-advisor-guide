---
title: "Getting a Mortgage With Bad Credit: What Actually Works"
date: 2026-07-08T17:15:21.286028+00:00
draft: false
...
slug: "can-i-get-a-mortgage-with-bad-credit"
affiliate_disclosure: true
faqs:
  - q: "Can I get a mortgage with a 500 credit score?"
    a: "Yes, technically. FHA loans allow scores as low as 500 with a 10% down payment. In practice, you'll find that many individual lenders set their own minimums at 580 or higher even for FHA products, so you'll need to shop around and specifically look for lenders who do manual underwriting or have more flexible overlays."
  - q: "Will applying for a mortgage hurt my credit score?"
    a: "A little, yes. A single hard inquiry typically drops a score by fewer than five points and the effect fades within a few months. If you apply with multiple lenders within a short window (generally 14 to 45 days), most modern scoring models count those as a single inquiry, so shopping around doesn't compound the damage the way people fear."
  - q: "How long do I need to wait after a bankruptcy to get a mortgage?"
    a: "It depends on the loan type and the chapter filed. For FHA loans, the waiting period after a Chapter 7 discharge is generally two years; Chapter 13 can sometimes be as short as one year with court approval and a strong payment record. Conventional loans typically require four years after Chapter 7. These timelines can feel brutal, but they're fixed, and working on your credit during the waiting period means you'll be in much better shape when you can apply."
  - q: "Is it better to save a bigger down payment or improve my credit score first?"
    a: "Honestly, it depends on where your score is. If you're below 580, improving your score to get to 580 will expand your loan options significantly and is probably worth a few months. If you're already at 600 to 620, a larger down payment could offset some of the rate penalty, but improving the score is still usually the higher-leverage move. Run both scenarios by a HUD-approved counselor who isn't trying to sell you anything."
  - q: "Do all lenders use the same credit score minimum?"
    a: "No, and this trips people up constantly. The FHA and VA set minimum guidelines, but individual lenders add their own requirements on top (called overlays). One lender might approve you at 580; another might decline the same file because their internal minimum is 620. This is exactly why talking to multiple lenders, including credit unions and smaller mortgage companies, is so important when your credit isn't perfect."
---
...
|---|---|---|---|---|
| FHA (580+) | 580 | 3.5% | Required (upfront + monthly) | Most bad-credit borrowers |
| FHA (500-579) | 500 | 10% | Required (upfront + monthly) | Very low scores with savings |
| VA | No official minimum (lenders typically 580+) | 0% | None | Eligible veterans/military |
| USDA | 640 (automated); lower possible manually | 0% | Required (lower than FHA) | Rural/suburban buyers |
| Conventional | 620 | 3% to 20% | Required if < 20% down | Stronger profiles |
| Non-QM / Portfolio | Varies (often 500+) | 10% to 20%+ | Varies | Self-employed, unique situations |
...
**Step 5: Talk to a HUD-approved housing counselor.** I know that sounds like something I'm supposed to say, but I mean it. [HUD-approved housing counselors](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) offer free or low-cost sessions, and they can look at your full financial picture without trying to sell you a loan. I've referred people there who came back two months later genuinely ready to buy, where before they weren't.
...
The [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) publishes data on how credit scores interact with loan performance and pricing, which is part of why lenders price so differently based on score tiers. The cutoffs aren't arbitrary. They're actuarial.

## Sources

- [FHA Single Family Housing Policy Handbook (HUD.gov)](https://www.hud.gov/program_offices/housing/sfh/handbook_references): Official FHA loan requirements including credit score minimums and mortgage insurance rules.
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Data on loan performance, pricing, and conventional loan standards.
- [AnnualCreditReport.com](https://www.annualcreditreport.com): Official free credit report access authorized under federal law.
- [Consumer Financial Protection Bureau (CFPB) Mortgage Credit Report Resources](https://www.consumerfinance.gov/consumer-tools/credit-reports-and-scores/): Plain-language explanations of credit scoring and disputing errors.
- FTC Consumer Report (2021): "In Brief: The Credit Report Study" (referenced figure: approximately 1 in 5 reports contains an error that affects credit).
...
If you're in research mode right now and want to get your head around the full home-buying process, the [HUD-approved housing counselor locator](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) is free and genuinely useful. For people who learn better from a book, something like *The Home Buying Bible* or a solid first-time buyer guide on [Amazon](https://www.amazon.com) (the site may earn a commission on purchases) can help you build context before your first lender conversation. Walking in knowing what questions to ask changes everything.
