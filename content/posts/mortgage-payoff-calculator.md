...
One thing worth tracking: the [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) publishes data on prepayment trends and mortgage behavior that can give you useful context on how other borrowers are handling their loans in different rate environments.

If you want to go deeper on the underlying math, a book like [*The Mortgage Professor's Guide to Mortgage Shopping*](https://www.amazon.com/s?k=mortgage+professor+guide&tag=contentportfo-20) (Amazon, affiliate link, site may earn a commission) can help you understand how amortization actually works beyond what any calculator shows on screen.
