...
image: "https://images.pexels.com/photos/8730012/pexels-photo-8730012.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"
categories: ["Closing"]
...
faqs:
  - q: "How long does a title search take?"
    a: "For a straightforward residential property with a clean history, expect one to three weeks. Properties with complex ownership histories, multiple prior owners, estate sales, or incomplete public records can take longer. If you're buying a foreclosure or a property that's been vacant for years, build extra time into your timeline."
  - q: "Can a title search miss something?"
    a: "Yes. A title search is only as good as the public records it can access. Forged documents, off-record claims, survey disputes, and certain types of fraud can slip through even a thorough search. That's a core reason owner's title insurance exists: it covers defects that weren't discovered before closing, not just ones that were."
  - q: "Do I need a title search if I'm paying cash?"
  ...
  - q: "What happens if the title search finds a problem?"
...
## What a Title Search Actually Is (And Why It's Not Optional)

A title search is a review of public records to verify that the person selling you a home actually has the legal right to sell it, and that the property isn't carrying any hidden claims, debts, or legal complications that would follow it to you at closing.
...
**Errors in public records.** A misspelled name, an incorrectly recorded deed, or a clerical mistake from decades ago can create a gap in the chain of title. These are surprisingly common.

**Undisclosed heirs.** If a previous owner died without a clean will or probate proceeding, an heir could theoretically claim an interest in the property years later.

**Forged or fraudulent deeds.** It happens. Deed fraud is rare but real, and it surfaces in title searches.

**Boundary and survey disputes.** Easements, encroachments, and questions about where the lot lines actually fall can all create title issues.
