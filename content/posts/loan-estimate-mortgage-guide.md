---
title: "Loan Estimate Mortgage Guide: Comparing Offers"
date: 2026-07-31T17:12:49.777198+00:00
draft: false
description: "Learn how to read and compare loan estimates when shopping for a mortgage. Understand fees, rates, and terms before you sign."
image: "/img/heroes/36021672.jpg"
categories: ["Getting Started"]
tags: ["loan", "estimate", "mortgage", "guide"]
author: "Maria Santos"
...
slug: "loan-estimate-mortgage-guide"
affiliate_disclosure: true
faqs:
  - q: "How long do I have to act on a Loan Estimate?"
    a: "A Loan Estimate is valid for 10 business days. After that, the lender can revise it. You don't have to commit immediately, but if rates move, your estimate may be updated."
  - q: "Can fees change between the Loan Estimate and closing?"
    a: "Some can, some can't. Origination fees and lender-required services are locked. Fees in the 'shop for' category can increase up to 10% in aggregate. Prepaids and escrow setup can change more freely because they're based on real-world variables like your closing date and insurance premium."
  - q: "What's the difference between the interest rate and APR on a Loan Estimate?"
    a: "The interest rate is what the lender charges you to borrow. The APR folds in most closing costs (fees, points) and spreads them over the life of the loan, giving you a more complete picture of the loan's true annual cost. A big gap between the two means high upfront fees."
  - q: "Do I need to formally apply to get a Loan Estimate?"
    a: "Yes. Under federal law, a lender can only issue a Loan Estimate after you've submitted an actual application, which requires your name, income, Social Security number, property address, estimated value, and loan amount. A 'pre-qualification' letter is not the same thing and carries no fee protections."
  - q: "Should I use an online mortgage calculator before comparing Loan Estimates?"
    a: "It helps to have a ballpark before you start. Mortgage calculators and home-buying guides on Amazon (the site may earn a commission) can help you estimate payments and understand amortization before your first lender conversation, so you're not starting from zero when the numbers hit you."
---
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Lenders must deliver a Loan Estimate within 3 business days of your application, by law.</li><li style="margin:5px 0">Page 3 compares your annual percentage rate (APR) to the interest rate, a gap over 0.5% deserves questions.</li><li style="margin:5px 0">"Can't increase" fees are locked; "can increase up to 10%" fees can creep on you before closing.</li><li style="margin:5px 0">You can and should get Loan Estimates from multiple lenders and compare them side by side.</li><li style="margin:5px 0">A higher rate with lower fees sometimes costs less over 5 years than a lower rate with high origination charges.</li></ul></div>


## What the Three Pages Actually Cover

Page one is the summary: loan amount, interest rate, monthly payment, and estimated [closing costs](/mortgage-closing-costs-explained/). It also tells you whether your rate is locked and for how long. This is what most people look at and then stop.

Don't stop there.

Page two is where the money is. It breaks closing costs into two buckets: fees you shop for (like [title insurance](/title-insurance-explained/) and settlement services) and fees you can't shop for (like government recording fees). The CFPB mandated this distinction because lenders used to bury padded fees in the "can't change" column. Now, any fee listed under "Services You Can Shop For" means you can call around and get a cheaper provider. I've seen buyers save $400 to $800 on title insurance alone just by doing 20 minutes of comparison shopping.
...
This is the part where I've seen the most confusion, including my own early confusion.
...
The "can't increase" column is your protection. If a lender quotes you $1,200 in origination fees on your Loan Estimate and charges $1,800 on your [Closing Disclosure](/closing-disclosure-explained/) three weeks later, that's a legal violation. It happens less than it used to, but it still happens with fees that get misclassified.
...
- [Consumer Financial Protection Bureau (CFPB)](https://www.consumerfinance.gov/owning-a-home/): Official explainer on the Loan Estimate form, fee categories, and borrower rights under TRID (TILA-RESPA Integrated Disclosure rules)
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Research on mortgage shopping behavior and rate quote outcomes
