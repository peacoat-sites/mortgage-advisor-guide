---
title: "Mortgage Divorce Buyout: How to Buy Out Your Ex's Stake"
date: 2026-07-13T17:45:07.427178+00:00
draft: false
...
slug: "mortgage-divorce-buyout"
affiliate_disclosure: true
faqs:
  - q: "Can I remove my ex from the mortgage without refinancing?"
    a: "Almost never. Some lenders offer a 'loan assumption' where one borrower takes over the loan, but these are rare and most conventional loans don't allow them. Refinancing into a new loan solely in your name is the standard approach, and it's the only way to truly remove your ex's legal liability."
  - q: "What if my ex won't sign the quitclaim deed?"
    a: "This is a real problem and it does happen. If your divorce decree specifies that the deed transfer must occur, you may be able to get a court order compelling them to sign. This is why having an attorney draft the divorce settlement with explicit property transfer language matters, not just a vague 'she gets the house.'"
  - q: "Does it matter whose name is on the deed vs. the mortgage?"
    a: "Yes, and they're separate. The deed determines ownership; the mortgage determines who's legally responsible for the debt. You can be on the deed but not the mortgage (ownership without debt liability) or on the mortgage but not the deed (debt without ownership). In a buyout, you want to end up on both the deed and the new mortgage, with your ex removed from both."
  - q: "How long does a divorce buyout refinance typically take?"
    a: "Budget 45 to 75 days from application to closing, assuming no complications. The appraisal scheduling alone can add 1 to 3 weeks depending on your market. If you're on a court-ordered deadline, start the lender process the day your settlement is signed, not after."
  - q: "Does a divorce buyout trigger capital gains tax?"
    a: "Usually not at the time of the buyout itself, because transfers between spouses as part of a divorce are generally not taxable events under IRS rules. But your tax basis in the home can shift, which affects what you owe when you eventually sell. A tax professional familiar with real estate is worth the $200 to $400 consultation fee here, because the answer genuinely depends on your specific situation."
---
...
A reader named Patricia emailed me after going through exactly this: she and her ex agreed to offset his $89,000 equity share against her 401(k). What they didn't account for was that a 401(k) dollar isn't worth the same as a home equity dollar after taxes. She came out short. If you're doing this, a [HUD-approved housing counselor](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) can help you think through the housing side, and a financial planner can model the asset offset math.

## Sources

- [Consumer Financial Protection Bureau (CFPB) - Owning a Home](https://www.consumerfinance.gov/owning-a-home/): Plain-language guides on refinancing, mortgage basics, and homeowner rights
- [HUD Housing Counselors](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor): Free or low-cost counseling for homeowners navigating major financial transitions including divorce
