---
title: "Mortgage Rate Lock Explained"
date: 2026-05-24T10:54:24.485429+00:00
draft: false
...
image: "https://pixabay.com/get/gc65d57dc8ba55092d9428809529d26c2dd32bed3e068684840601ac9aff3fa194c0f3f41437c53a752ac032ee2542c1bab96c73a178c6fc073d8526bcd0d7d28_1280.jpg"
categories: ["Rates"]
...
**30-day lock:** Can work for a purchase if you're under contract, the property is already appraised or waived, and your file is clean and complete. Even then, it's tight. I've seen closings fall to 31 days because a title company had a scheduling conflict.

**45-day lock:** This is the most common choice for purchase transactions and the one I'd consider the practical default. It gives the lender enough runway to complete underwriting, order and receive the appraisal, coordinate with title, and handle the back-and-forth of conditions without everyone panicking.

**60-day or longer lock:** New construction, complex income situations (self-employed borrowers, recently divorced applicants), or any deal with known complications. Expect a pricing premium, typically 0.125% to 0.25% higher than a 30-day lock, though this varies by lender.

Before you commit to a lock period, ask your loan officer exactly how many business days they typically need from a complete application to a clear-to-close. Get that answer in writing, and then add a week as a buffer. You're trying to choose the shortest lock that realistically covers your closing date.

## The Cost of Getting the Timing Wrong

Rate lock mistakes fall into two categories: locking too early or locking too late.
...
**Locking too late** is the other trap. Some borrowers think they'll outsmart the market by waiting for rates to dip. That can work. It can also blow up spectacularly. Rates can move 0.25% or more in a single week during volatile periods, and I've seen a 0.5% move happen in a day following an unexpected economic report. You can't time the market reliably. Most professionals in this industry can't either.

The [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) publishes data on mortgage rate trends regularly, and even with all that data, the professionals can't predict short-term movements with consistency. Don't bet your housing costs on your ability to do what economists can't.

## Float-Down Options: The Hedge That Costs More Than You Think

A float-down option lets you capture a lower rate if market rates drop after you've locked. It sounds like the best of both worlds. It rarely is.
...
## Step-by-Step: How to Lock Your Rate the Right Way

This is the sequence I'd recommend for any purchase borrower. Follow it and you'll avoid the most common, and most expensive, lock mistakes.

**Step 1: Get pre-approved before you shop.** A pre-approval gives you a realistic rate range, surfaces any credit or income issues before they become crises, and lets you move quickly when you find the right home. You can't lock without an accepted offer, but being pre-approved means you're ready to lock immediately. Learn more about [what the mortgage pre-approval process involves](/mortgage-pre-approval-process/) before you start house hunting.

**Step 2: Monitor rates actively once you're under contract.** Check daily. Use a lender's rate sheet, a mortgage news source, or the tools available at [Freddie Mac's home buyer resources](https://myhome.freddiemac.com/). You don't need to become a rate analyst, but you should understand the general direction of the market.

**Step 3: Ask your loan officer for an honest closing timeline.** How long does underwriting take at this lender? How long does the appraisal typically add? Is there anything in your file that could cause delays? Then add five to seven business days as a buffer.

**Step 4: Choose your lock period based on that timeline, not the rate alone.** The small premium on a 45-day lock versus a 30-day lock is almost always worth the breathing room.

**Step 5: Get the lock confirmation in writing.** Every lender should provide a rate lock confirmation that specifies the locked rate, the loan program, the lock expiration date, and any float-down terms. If you don't receive this document, ask for it explicitly. Don't assume a verbal confirmation is binding.

**Step 6: Keep your finances stable until you close.** Don't open new credit accounts. Don't quit your job. Don't buy a car. Don't make large unexplained deposits into your bank accounts. Any of these can trigger a re-underwrite, which can put your lock at risk even if the expiration date hasn't arrived.
