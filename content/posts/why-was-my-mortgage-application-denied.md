---
title: "Mortgage Denied? 7 Real Reasons Lenders Reject Applications"
date: 2026-07-09T17:45:56.630123+00:00
draft: false
description: "Find out exactly why your mortgage application was denied and what steps you can take now to fix the problem and get approved."
image: "/img/heroes/7731323.jpg"
categories: ["Underwriting"]
tags: ["mortgage", "application", "denied"]
author: "Ethan Chen"
...
slug: "why-was-my-mortgage-application-denied"
affiliate_disclosure: true
faqs:
  - q: "Can I reapply right away after being denied?"
    a: "You can, but usually you shouldn't. If the reason for denial isn't fixed, you'll just get denied again and collect another hard credit inquiry. Take 60-90 days minimum to address the actual problem, then reapply."
  - q: "Does a mortgage denial hurt my credit score?"
    a: "The application itself (a hard inquiry) typically drops your score by a few points temporarily. The denial itself doesn't appear on your credit report. Multiple applications in a short window do more damage because of stacked inquiries."
  - q: "Can I appeal a mortgage denial?"
    a: "Not in a formal sense. Lenders aren't required to reconsider. But if you believe the denial was based on inaccurate information (wrong income calculation, a collection that isn't yours), you can provide corrected documentation and ask the lender to re-review. Sometimes it works."
  - q: "What if I was denied because of my income type, not the amount?"
    a: "This is common for self-employed borrowers. A conventional lender uses your net income from tax returns, which is often lower than what you actually deposit. Some lenders offer alternative documentation programs. It's worth shopping specifically for lenders who work with self-employed borrowers rather than assuming all lenders will treat your income the same way."
  - q: "How long does a mortgage denial stay on my record?"
    a: "It doesn't, not in the way people fear. The hard inquiry from the application stays on your credit report for two years but stops affecting your score after about one year. There's no public 'denied mortgage' record that follows you. Each lender evaluates you fresh."
---
...
You're entitled to a free copy of your credit report if you're denied, and the [Consumer Financial Protection Bureau (CFPB)](https://www.consumerfinance.gov/owning-a-home/) has a good breakdown of your rights under the FCRA. Use them.
...
Most denials trace back to a handful of issues. Not dozens. Here's where they actually cluster:
...
| Derogatory Event | Conventional Loan Wait | FHA Loan Wait | VA Loan Wait |
|---|---|---|---|
| Chapter 7 Bankruptcy | 4 years | 2 years | 2 years |
| Chapter 13 Bankruptcy | 2 years from discharge | 1 year from filing (with court permission) | 1 year |
...
The [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/) publishes data on the characteristics of approved and denied loans if you want to see where your numbers land relative to the broader market.
...
- [Consumer Financial Protection Bureau (CFPB)](https://www.consumerfinance.gov/owning-a-home/): Official guidance on mortgage denial rights, credit report access, and ECOA protections
- [Federal Housing Finance Agency (FHFA)](https://www.fhfa.gov/): Loan-level data on approval and denial patterns across conventional loan programs
