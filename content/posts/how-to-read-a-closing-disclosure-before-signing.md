---
title: "Reading Your Closing Disclosure: What to Check Before Signing"
date: 2026-07-21T17:05:51.734045+00:00
draft: false
description: "Learn what to look for on your closing disclosure form and catch errors before you sign. Key figures and terms explained."
image: "/img/heroes/7821674.jpg"
categories: ["Closing"]
tags: ["read", "closing", "disclosure", "before", "signing"]
author: "Robert Kim"
...
slug: "how-to-read-a-closing-disclosure-before-signing"
affiliate_disclosure: true
faqs:
  - q: "What happens if I find an error on my Closing Disclosure?"
    a: "Contact your loan officer immediately and document the discrepancy in writing (email is fine). If a zero-tolerance fee increased from your Loan Estimate without a valid 'changed circumstance' reason, the lender is required to correct it. You have the right to delay closing until errors are resolved."
  - q: "Can I negotiate fees on the Closing Disclosure?"
    a: "Some fees, like lender origination charges, are sometimes negotiable even at this late stage, though it's harder than at application. Third-party fees like title insurance or settlement agent charges may be harder to adjust. The best time to negotiate is before you lock your rate, but it doesn't hurt to ask."
  - q: "Do I have to use the same title company or settlement agent the lender suggests?"
    a: "For services in Section C of your Loan Estimate (services you can shop for), you generally have the right to choose your own provider. If you use a provider not on the lender's approved list, make sure to get a quote and confirm the lender will work with them before you get too close to closing."
  - q: "What's the difference between 'cash to close' and my down payment?"
    a: "Your down payment is one component of cash to close. Cash to close also includes closing costs, prepaid items (insurance, interest, taxes), and your initial escrow deposit, minus any lender credits or seller concessions. The two numbers are often quite different."
  - q: "Is the Closing Disclosure the final word, or can it change again?"
    a: "The CD can be revised if something material changes before closing, like your loan amount, your interest rate, or a significant change in a third-party fee. Each revision resets the three-business-day clock. This is rare and usually signals a real change in your loan terms, so pay attention if you receive a revised CD and start the comparison process over."
---
...
That document was the [Closing Disclosure](/closing-disclosure-explained/). And "don't worry about it, it's standard" is maybe the worst piece of advice a borrower can receive.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">You have 3 business days to review your Closing Disclosure before closing, federal law requires this.</li><li style="margin:5px 0">Compare every fee on your CD to your original Loan Estimate; unexplained increases are a red flag.</li><li style="margin:5px 0">Check the loan terms box on page 1 first: your rate, loan amount, and whether it can change.</li><li style="margin:5px 0">Section B fees (third-party services) can shift; Section A fees (lender fees) should not change at all.</li><li style="margin:5px 0">Ask about any fee over $50 that wasn't on your Loan Estimate, you have every right to an explanation.</li></ul></div>


## What a Closing Disclosure Actually Is (and Why It's Different from Your Loan Estimate)

When you applied for your mortgage, you got a Loan Estimate within three business days. That was the "here's what we think this will cost" document. The Closing Disclosure is the "here's what it actually costs" document. Think of the Loan Estimate as the restaurant menu and the Closing Disclosure as the itemized [bill that](/the-housing-bill-that-passed-congress-but-stalled-at-the-white-house/) arrives at your table.

The CFPB designed both forms to use the same layout, specifically so you can put them side by side and spot differences. [The Consumer Financial Protection Bureau's homeownership resources](https://www.consumerfinance.gov/owning-a-home/) walk through both documents in detail, and if you haven't bookmarked that site already, do it now. It's genuinely useful.
...
| Section | What It Covers | Can It Change vs. Loan Estimate? |
|---|---|---|
| A | Origination charges (lender fees) | Zero tolerance, cannot increase |
| B | Services you cannot shop for (appraisal, credit report) | Zero tolerance, cannot increase |
| C | Services you can shop for (title, settlement agent) | Up to 10% increase allowed |
| E | Taxes and government fees | Zero tolerance, cannot increase |
| F | Prepaids (homeowner's insurance, prepaid interest, property taxes) | Can change (based on actual figures) |
| G | Initial escrow payment | Can change (based on actual figures) |
| H | Other (HOA fees, home warranty, etc.) | Can change |
...
- [Consumer Financial Protection Bureau (CFPB) -- Your Home Loan Toolkit](https://www.consumerfinance.gov/owning-a-home/): Official guide to the Loan Estimate and Closing Disclosure, including tolerance categories for fees
- [Freddie Mac, My Home by Freddie Mac](https://myhome.freddiemac.com/): Homebuyer education resources including loan amortization tools and mortgage explainers
