...
What amazes me is how many loan officers skip this calculation entirely. Some do it. Most don't. The [Consumer Financial Protection Bureau has a loan comparison worksheet](https://www.consumerfinance.gov/owning-a-home/) that walks you through exactly this kind of side-by-side analysis. Use it before your next lender call.
...
The smart move: ask your lender to show you the Loan Estimate with and without points side by side, then run the breakeven math using your actual timeline. If you want a resource that walks you through all your homebuying numbers at once, something like [*The Mortgage Encyclopedia* by Jack Guttentag](https://www.amazon.com/s?k=mortgage+encyclopedia+guttentag&tag=) offers solid grounding on loan math without the sales pitch.
