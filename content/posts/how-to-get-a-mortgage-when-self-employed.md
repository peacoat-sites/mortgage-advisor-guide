...
faqs:
  - q: "How long do I need to be self-employed before I can get a mortgage?"
    a: "Most conventional lenders require a two-year self-employment history, verified through tax returns. Some lenders will consider 12 months if you have prior employment in the same field and can show a full year of returns, but that's case-by-case and not a standard exception."
  - q: "Can I qualify for a mortgage using bank statements instead of tax returns?"
    a: "Yes, through Non-QM or bank statement loan programs. You'll typically need 12-24 months of statements showing consistent deposits. The tradeoff is a higher interest rate and often stricter down payment requirements compared to conventional financing."
  - q: "Do lenders count my gross business revenue or net income?"
    a: "Net income after expenses, which is what your tax return shows. Underwriters then add back certain non-cash deductions like depreciation. Gross revenue doesn't count unless you're using a bank statement loan program, which applies an expense factor to your deposits."
  - q: "Will being self-employed automatically mean a higher interest rate?"
...
Most conventional lenders require a two-year self-employment history, verified through tax returns. Some lenders will consider 12 months if you have prior employment in the same field and can show a full year of returns, but that's case-by-case and not a standard exception.

### Can I qualify for a mortgage using bank statements instead of tax returns?

Yes, through Non-QM or bank statement loan programs. You'll typically need 12-24 months of statements showing consistent deposits. The tradeoff is a higher interest rate and often stricter down payment requirements compared to conventional financing.

### Do lenders count my gross business revenue or net income?

Net income after expenses, which is what your tax return shows. Underwriters then add back certain non-cash deductions like depreciation. Gross revenue doesn't count unless you're using a bank statement loan program, which applies an expense factor to your deposits.

### Will being self-employed automatically mean a higher interest rate?

Not if you qualify conventionally. Your rate is determined by your credit score, loan-to-value ratio, loan type, and market conditions, not your employment type. You'll only pay a rate premium if you need a Non-QM product because you can't qualify through standard guidelines.

### What if one of my two years of tax returns shows a loss?

A loss year is serious and can hurt your application significantly. Lenders typically average the two years, so a loss on year one can offset strong income in year two. Some lenders will use only the lower year rather than the average. Talk to a broker or lender before assuming a loss year disqualifies you entirely, because guidelines vary and there are sometimes compensating factors.
