---
title: "Mortgage Forbearance: Pause Payments Without Losing Your Home"
date: 2026-07-17T16:54:03.281500+00:00
draft: false
description: "Learn how mortgage forbearance agreements let you temporarily pause or reduce payments during financial hardship without defaulting on your loan."
image: "/img/heroes/8293742.jpg"
categories: ["Hardship Options"]
tags: ["does", "mortgage", "forbearance", "agreement", "work"]
author: "Maria Santos"
...
slug: "how-does-a-mortgage-forbearance-agreement-work"
affiliate_disclosure: true
faqs:
  - q: "Does forbearance hurt your credit score?"
    a: "It depends on how your servicer reports it. If they report your account as 'in forbearance' rather than 'current,' it may signal risk to lenders even without a missed-payment notation. Always ask your servicer in writing how they'll report the account before agreeing to forbearance."
  - q: "Do you have to pay back everything at once when forbearance ends?"
    a: "Not necessarily. A lump sum is one option, but most servicers offer repayment plans, deferral, or loan modifications. The key is to know your options before the forbearance period ends, not after, because servicers vary on what they proactively offer."
  - q: "Can you be denied forbearance?"
    a: "For federally backed loans (FHA, VA, USDA, Fannie Mae, Freddie Mac), servicers have specific obligations to offer forbearance for documented hardships. For private or jumbo loans, the servicer has more discretion. If you're denied, ask for the reason in writing and check whether your loan is federally backed."
  - q: "Does interest keep accruing during forbearance?"
    a: "For most conventional and government-backed loans, yes, interest continues to accrue on the outstanding balance even when payments are paused. This means your total repayment amount grows slightly over the forbearance period. Check your specific agreement for confirmation."
  - q: "Will a forbearance affect your ability to refinance or buy another home?"
    a: "Possibly, yes. Many lenders require a waiting period after forbearance, often 3 to 12 months of on-time payments after the forbearance exits, before they'll approve a refinance. Some loan programs have stricter requirements. Ask a lender about their specific seasoning requirements before applying."
---

Most articles about [mortgage forbearance](/mortgage-forbearance-impact-on-credit/) make it sound like a polite vacation from your loan. You pause, you breathe, you resume. What they skip is the part where you come back from that "vacation" and someone hands you a bill for six months of missed payments all at once.
...
<div class="kt" style="margin:26px 0;padding:18px 22px;border:1px solid var(--border,#e7e5e4);border-left:4px solid var(--accent,#4338ca);border-radius:12px;background:var(--surface2,#f8fafc)"><div style="font-size:.72rem;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:var(--accent,#4338ca);margin-bottom:8px">Key takeaways</div><ul style="margin:0;padding-left:1.15em"><li style="margin:5px 0">Forbearance pauses or reduces mortgage payments temporarily; it does NOT erase what you owe.</li><li style="margin:5px 0">Missed payments must be repaid, either in a lump sum, repayment plan, or loan modification.</li><li style="margin:5px 0">Credit impact depends on how your servicer reports it, ask before you sign anything.</li><li style="margin:5px 0">Forbearance periods typically run 3 to 12 months, sometimes longer for federally backed loans.</li><li style="margin:5px 0">Requesting forbearance does not automatically protect you from late fees unless your servicer confirms it in writing.</li></ul></div>
...
You don't apply for forbearance through a government website or a form you find on Google. You call your servicer directly. The number is on your monthly statement.
...
This is the table most articles leave out.
...
The CFPB's [owning a home resources](https://www.consumerfinance.gov/owning-a-home/) lay out these exit options clearly, and it's worth reading before you call your servicer so you're not hearing these terms for the first time mid-conversation.
...
- [Consumer Financial Protection Bureau (CFPB) - Mortgage Forbearance Resources](https://www.consumerfinance.gov/owning-a-home/): Official guidance on forbearance options, servicer obligations, and exit strategies.
- [Freddie Mac - My Home by Freddie Mac](https://myhome.freddiemac.com/): Loan-specific forbearance rules for conforming mortgages, homebuyer education resources.
- [Federal Housing Finance Agency (FHFA) - COVID-19 and Mortgage Relief](https://www.fhfa.gov/): Documentation of forbearance policy history for Fannie/Freddie loans and ongoing servicer guidelines.
- [HUD FHA Servicing Guidelines (Mortgagee Letters)](https://www.hud.gov/program_offices/housing/sfh/nsc/nschome): FHA-specific loss mitigation options including partial claims.
- [Mortgage Bankers Association (MBA) - Forbearance Survey Data](https://www.mba.org/): Industry data on forbearance rates and exit outcomes over time.
