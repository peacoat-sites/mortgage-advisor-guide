...
slug: "respa-mortgage-rules"
affiliate_disclosure: true
faqs:
  - q: "Does RESPA apply to all mortgages?"
    a: "RESPA applies to 'federally related mortgage loans,' which covers the vast majority of residential mortgages on one-to-four-family properties. This includes loans made by federally regulated lenders, FHA and VA loans, and loans intended for sale to Fannie Mae or Freddie Mac. Seller-financed transactions and certain business-purpose loans are generally exempt."
  - q: "Can my lender require me to use a specific title company?"
    a: "No. Under RESPA Section 9, a seller cannot require you to purchase title insurance from a specific company as a condition of sale. Your lender can require title insurance but cannot mandate a specific provider. If you're being pressured into a particular title company without any choice offered, that's worth questioning directly and noting in writing."
  - q: "What should I do if my Closing Disclosure has fees that weren't on my Loan Estimate?"
    a: "Compare both documents side by side before closing. If a lender-controlled fee increased beyond the applicable tolerance, email your loan officer immediately citing the specific line items and asking for a corrected Closing Disclosure. Most lenders will correct legitimate errors rather than delay closing over them. Document everything in writing."
  - q: "How long does my servicer have to respond to a written complaint about my escrow account?"
...
The two disclosure documents that define your mortgage transaction both trace back to RESPA, though the specific forms were standardized through the 2015 TRID rule (TILA-RESPA Integrated Disclosure). If you've gotten a mortgage in the last decade, you've seen them.
...
Sounds tidy. In practice, servicers routinely miscalculate property tax projections and end up holding significantly more than they should. The [Consumer Financial Protection Bureau's owning a home resources](https://www.consumerfinance.gov/owning-a-home/) include guidance on reading your escrow analysis, and I'd recommend going through it if you've never done a real line-by-line check of yours.
...
[Freddie Mac's homebuyer resources](https://myhome.freddiemac.com/) include a plain-language overview of settlement costs that pairs well with understanding the disclosure forms RESPA requires.
...
- [Consumer Financial Protection Bureau (CFPB), RESPA resources](https://www.consumerfinance.gov/owning-a-home/): Official guidance on RESPA rules, escrow accounts, and closing disclosures, current as of 2026.
...
- [Freddie Mac My Home](https://myhome.freddiemac.com/): Consumer-facing guides on the mortgage process, closing costs, and settlement disclosures.
