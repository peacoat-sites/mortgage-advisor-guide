...
faqs:
  - q: "How much do I actually need saved before I apply for a mortgage?"
    a: "There's no single answer, but a practical floor is this: you need your down payment (minimum 3% on some conventional loans, 3.5% on FHA), estimated closing costs of 2% to 5% of the loan amount, and ideally two to three months of housing payments in reserve after closing. If you're using a down payment assistance program that covers some of this, the calculation changes. The key is understanding that the down payment isn't the only cash requirement."
  - q: "Does getting pre-approved hurt my credit score?"
    a: "A single hard inquiry typically drops a FICO score by fewer than 5 points and the effect is temporary. If you apply with multiple mortgage lenders within a focused window (generally 14 to 45 days depending on the FICO model being used), those inquiries are usually treated as one for scoring purposes. Shopping for rates is smart financial behavior. Don't skip it out of fear of a minor, temporary score impact."
  - q: "What's the difference between interest rate and APR?"
    a: "The interest rate is the cost of borrowing the principal, expressed as a percentage. The APR (Annual Percentage Rate) includes the interest rate plus most lender fees, expressed as an annualized cost over the life of the loan. APR gives you a more complete picture of total cost. When comparing loans, comparing APRs is more useful than comparing interest rates alone, especially when lenders are charging different origination fees or discount points."
...
Credit score first. Conventional loans backed by Fannie Mae and Freddie Mac generally require a minimum 620 score, but you'll want to be closer to 740 or above to access the best pricing. Below 700, you start paying meaningful loan-level price adjustments, which are essentially risk surcharges built into your rate. An FHA loan lets you go as low as 580 with 3.5% down, or even 500 with 10% down, but the mortgage insurance costs on FHA can be steep. Don't assume your credit app on your phone shows the same score a mortgage lender pulls. Lenders use a tri-merge report pulling from Experian, Equifax, and TransUnion, and they often use older FICO scoring models like FICO 2, 4, and 5, not the newest versions. Pull your full reports at AnnualCreditReport.com and look for errors.
...
Cash matters more than people expect. Your down payment is only part of it. You'll also need closing costs, which typically run 2% to 5% of the loan amount, and reserves, meaning money left in the bank after closing. Some loan programs require two to six months of housing payments sitting in reserve post-close. That cash has to be sourced and seasoned, meaning documented and sitting in your account for at least 60 days. A large deposit from a family gift that shows up right before closing triggers underwriting scrutiny and requires a paper trail.
...
The critical detail most loan officers gloss over on FHA loans: if you put down less than 10%, you pay Mortgage Insurance Premium (MIP) for the entire life of the loan. On a conventional loan, private mortgage insurance (PMI) automatically cancels once you reach 20% equity. That difference can cost an FHA borrower thousands of dollars over time, and yet FHA is often pitched as the easy choice. Sometimes it is the right choice. Just know what you're agreeing to.

VA loans, available to eligible veterans, active-duty service members, and surviving spouses, are genuinely the best mortgage product available. Zero down payment, no monthly mortgage insurance, competitive rates. If you qualify, explore this option seriously before anything else.
...
2. 30 days of recent pay stubs
3. 60 days of bank statements (all pages, all accounts)
4. Government-issued ID
5. Authorization for a hard credit pull
6. If self-employed: two years of business and personal returns, a year-to-date profit and loss statement

Some lenders now offer what they call "fully underwritten pre-approvals" or "verified approvals," where a human underwriter actually reviews the file before you make an offer. This is the gold standard. It tells sellers you're as close to a sure thing as exists in mortgage lending.

Apply with at least two or three lenders within a short window. Multiple mortgage inquiries within a 14 to 45 day period are typically counted as a single inquiry for scoring purposes under most FICO models, so shopping around won't wreck your credit the way some buyers fear.
...
This is where a lot of buyers miss real money. There are hundreds of down payment assistance programs across the country at the state, county, and even city level. Some are grants. Some are forgivable second liens. Some are low-interest deferred loans. Eligibility typically hinges on income limits, purchase price limits, and completing a homebuyer education course.

[Freddie Mac's home buyer resources](https://myhome.freddiemac.com/) are a solid starting point for understanding what's available and how these programs work alongside conventional financing. Many buyers assume they earn too much to qualify, or that the programs are only for the very lowest income tiers. That's often wrong, especially in high-cost markets where income limits are adjusted upward.

HUD-sponsored homebuyer education is worth doing even if it's not required for your loan. You can find a [HUD-approved housing counselor](https://www.hud.gov/i_want_to/talk_to_a_housing_counselor) to walk you through the options in your specific area and help you evaluate whether a particular program actually benefits you. Some assistance programs come with strings attached, like required occupancy periods or resale restrictions. A HUD counselor will tell you exactly what those are.

If you're looking to go deeper on the preparation side, a resource like a [home-buying workbook or financial planning guide](https://www.amazon.com/s?k=first+time+home+buyer+guide+book) can help you organize your finances, track the steps, and ask better questions at every stage. (Note: this site may earn a commission on qualifying purchases.)

---

## The Steps in Order: What to Actually Do

Here's the practical sequence. Follow it in this order and you'll avoid most of the costly mistakes I've seen first-timers make.

1. **Pull your credit reports.** All three bureaus. Dispute any errors. Give yourself at least 60 to 90 days to resolve problems before applying.
2. **Calculate your real DTI.** Add up every minimum monthly debt payment. Divide by gross monthly income. Aim for 36% or below if possible.
3. **Determine your available cash.** Down payment plus closing costs plus reserves. Be honest.
4. **Research first-time buyer programs.** Check your state housing finance agency's website. Talk to a HUD counselor.
5. **Get pre-approved with multiple lenders.** Do this before you start seriously touring homes. Use the Loan Estimates to compare total costs.
6. **Set a real budget.** Pre-approval amount is not your budget. Calculate what monthly payment you're actually comfortable carrying given your full financial life.
7. **Work with a buyer's agent.** Preferably one experienced with first-time buyers who can help you write competitive offers.
8. **Lock your rate strategically.** Once under contract, talk to your lender about when to lock. Rate locks typically run 30 to 60 days. Understand the cost of extensions.
9. **Read every document before closing.** Compare your final Closing Disclosure to your Loan Estimate. Costs shouldn't change dramatically. If they have, ask why in writing.

---

## FAQ

### How much do I actually need saved before I apply for a mortgage?
...
Yes, but there are rules. Most loan programs allow gift funds from a family member, and some extend this to close friends or employers. The gift must be documented with a signed gift letter stating the money is not a loan and doesn't require repayment. The donor may also be asked to provide bank statements showing the source of funds. Large, undocumented deposits to your account close to closing will raise underwriting flags regardless of the source.
